				...
				<fieldset class="fld_comm">
					...
					<div class="box_comm box_terms">
						...
						<div id="termsAgreeContainer" class="cont_agreement">
							...
							<ol class="list_terms">
								...
								<li><span class="txt_num">②</span>
									<p class="txt_clause">회사가 제공하는 유료서비스에 대한 이용요금의 결제 방법은
										핸드폰결제, 신용카드결제, 일반전화결제, 계좌이체, 무통장입금, mango캐쉬 결제 등이 있으며 각 유료서비스마다
							...
							<p>본 약관은 2016년 10월 7일부터 적용됩니다. 단, 본 약관의 공지 시점으로부터 적용일 전일까지 기간
					...
					<div class="box_comm box_terms">
						<h5 class="tit_agreement">mango 개인정보 수집 및 이용 동의</h5>
