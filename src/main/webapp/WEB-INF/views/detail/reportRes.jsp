...
<body>
	...
	<form name="reportRes" action="http://localhost:8000/reportRes" method="POST">
	<div id="main">
		...
		<div id="main_section">
			<input type="radio" id="1" name="bt" value="1" onclick="change()">존재하지 않는 맛집입니다<br>
			<input type="radio" id="2" name="bt" value="2" onclick="change()">망고플레이트에 게시되기 적절하지 않습니다<br>
			<input type="radio" id="3" name="bt" value="3" onclick="change()">부적절한 사진이 포함되어있습니다<br>
