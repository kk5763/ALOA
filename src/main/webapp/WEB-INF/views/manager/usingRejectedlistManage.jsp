					...
					<div class="col-md-12">
						<div class="panel panel-primary filterable">
							<div class="panel-heading">
								<h3 class="panel-title">이용 불가 리스트관리<span style="color: white; font-weight: bold;"> *</span></h3>
								...
								<div class="bg tablescroll">
									<table class="table table-bordered table-striped">
										<tr>
											...
											<td style="width: 15%">yolip51</td>
											<td style="width: 35%">010-6667-1478</td>
											<td style="width: 20%"><input type="button" value="해제"></td>
										</tr>
